...
⚠️ __The STRATZ team [moved away](https://stratz.com/api) completely from the REST API. This package is no longer needed. Use the [GraphQL alternative](https://api.stratz.com/graphiql).__ ⚠️
...
- [⚠️ Deprecation Notice](#️-deprecation-notice)
  - [Stratz](#stratz)
